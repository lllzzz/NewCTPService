...
while True:
    ...
    if action in ['TRADE', 'FOK', 'FAK', 'IOC']:
        ...
        sql = '''
            INSERT INTO `trade` (`iid`, `from`, `trade_id`, `ctp_td_req_id`, `is_open`, `is_buy`, `volumn`, `price`, `is_today`, `action`, `send_time`)
    ...
    if action == 'TRADED':
        ...
        ctpOrderSysId = data['orderSysId']
        ctpTradeId = data['tradeId']
